...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-reticulate-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-reticulate-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add r-reticulate
# for installing globally
pixi global install r-reticulate
```
...
It is possible to list all of the versions of `r-reticulate` available on your platform:
...
```
pixi search r-reticulate --channel conda-forge
```
